...
public class Registers {
	...
	/**
	 * Size: 16 bits floating point registers
	 * 
	 */
	...
	String consoleKeyboard;
	String consolePrinter;
	String consoleCardReader;
	String otherConsoles;
	...
	public void setDeviceWithID(String id, String value) {
		switch(id) {
		case "0":
			consoleKeyboard = value;
			break;
		case "1":
			consolePrinter = value;
			break;
		case "2":
			consoleCardReader = value;
			break;
		default:
			otherConsoles = value;
		}
	...
	public String getFromDevice(String id) {
		switch (id) {
		case "1":
			return this.consoleKeyboard;
		case "2":
			return this.consolePrinter;
		case "3":
			return this.consoleCardReader;
		default:
			return this.otherConsoles;
		}
	}
	...
	public String getFloatingRegisterj(String input) {
		switch(input) {
		case "00":
			return fr0;
		case "01":
			return fr1;
		default:
			System.out.println("Error, FR should be in 00 or 01, not " + input );
			return null;
		}
	}
	
	public void setFloatingRegisterj(String frj, String input) {
		switch(frj) {
		case "00":
			this.fr0 = input;
			break;

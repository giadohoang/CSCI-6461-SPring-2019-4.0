...
public class FrontEnd {
	...
	Program1 program1;
	Program2 program2;
	//String paragraph is used for program2 Find Button
	String paragraph;
	// Cache cache;
	...
	private void initialize() {
		...
		frmCsciSimulator.getContentPane().addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		frmCsciSimulator.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		frmCsciSimulator.getContentPane().setForeground(Color.WHITE);
		frmCsciSimulator.getContentPane().setBackground(new Color(51, 51, 61));
		...
		frmCsciSimulator.setTitle("CSCI 6461 SIMULATOR PROJECT ver 4.0");
		frmCsciSimulator.setBounds(100, 100, 1599, 862);
		frmCsciSimulator.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmCsciSimulator.getContentPane().setLayout(null);
		
		JSeparator separator_18 = new JSeparator();
		separator_18.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		frmCsciSimulator.getContentPane().add(separator_18);
		
		btn_FindProgram2 = new JButton("2. Find");
		btn_FindProgram2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		btn_FindProgram2.setBounds(1388, 472, 89, 23);
		frmCsciSimulator.getContentPane().add(btn_FindProgram2);
		
		btn_StartProgram2 = new JButton("1. Start");
		btn_StartProgram2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		btn_StartProgram2.setBounds(1274, 472, 89, 23);
		frmCsciSimulator.getContentPane().add(btn_StartProgram2);

		btn_FindProgram1 = new JButton("2. Find");
		btn_FindProgram1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		btn_FindProgram1.setBounds(1388, 254, 89, 23);
		frmCsciSimulator.getContentPane().add(btn_FindProgram1);

		separator_13 = new JSeparator();
		separator_13.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_13.setBounds(575, 40, 13, 555);
		frmCsciSimulator.getContentPane().add(separator_13);

		separator_14 = new JSeparator();
		separator_14.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_14.setBounds(550, 40, 2, 555);
		frmCsciSimulator.getContentPane().add(separator_14);

		separator_15 = new JSeparator();
		separator_15.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_15.setBounds(525, 40, 2, 555);
		frmCsciSimulator.getContentPane().add(separator_15);

		separator_8 = new JSeparator();
		separator_8.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_8.setBounds(500, 40, 2, 562);
		frmCsciSimulator.getContentPane().add(separator_8);

		separator_9 = new JSeparator();
		separator_9.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_9.setBounds(475, 40, 13, 562);
		frmCsciSimulator.getContentPane().add(separator_9);

		separator_10 = new JSeparator();
		separator_10.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_10.setBounds(450, 40, 2, 555);
		frmCsciSimulator.getContentPane().add(separator_10);

		separator_11 = new JSeparator();
		separator_11.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_11.setBounds(423, 40, 4, 555);
		frmCsciSimulator.getContentPane().add(separator_11);

		separator_4 = new JSeparator();
		separator_4.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_4.setBounds(400, 40, 2, 550);
		frmCsciSimulator.getContentPane().add(separator_4);

		separator_5 = new JSeparator();
		separator_5.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_5.setBounds(375, 40, 2, 550);
		frmCsciSimulator.getContentPane().add(separator_5);

		separator_6 = new JSeparator();
		separator_6.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_6.setBounds(350, 40, 2, 562);
		frmCsciSimulator.getContentPane().add(separator_6);

		separator_7 = new JSeparator();
		separator_7.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_7.setBounds(325, 40, 2, 562);
		frmCsciSimulator.getContentPane().add(separator_7);

		separator_2 = new JSeparator();
		separator_2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_2.setBounds(300, 40, 2, 550);
		frmCsciSimulator.getContentPane().add(separator_2);

		separator_3 = new JSeparator();
		separator_3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_3.setBounds(275, 40, 2, 550);
		frmCsciSimulator.getContentPane().add(separator_3);

		separator_1 = new JSeparator();
		separator_1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator_1.setBounds(250, 40, 2, 562);
		frmCsciSimulator.getContentPane().add(separator_1);

		separator = new JSeparator();
		separator.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		separator.setBounds(225, 40, 2, 562);
		frmCsciSimulator.getContentPane().add(separator);

		panelMAR = new JPanel();
		panelMAR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelMAR.setBackground(new Color(51,51,61));
		...
		panelMBR = new JPanel();
		panelMBR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelMBR.setBackground(new Color(51,51,61));
		...
		panelX1 = new JPanel();
		panelX1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelX1.setBackground(new Color(51,51,61));
		...
		panelX2 = new JPanel();
		panelX2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelX2.setBackground(new Color(51,51,61));
		...
		panelX3 = new JPanel();
		panelX3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelX3.setBackground(new Color(51,51,61));
		...
		panelR0 = new JPanel();
		panelR0.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelR0.setBackground(new Color(51,51,61));
		...
		panelR1 = new JPanel();
		panelR1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelR1.setBackground(new Color(51,51,61));
		...
		panelR2 = new JPanel();
		panelR2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelR2.setBackground(new Color(51,51,61));
		...
		panelR3 = new JPanel();
		panelR3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelR3.setBackground(new Color(51,51,61));
		...
		panelCUSTOM.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelCUSTOM.setBackground(new Color(51,51,61));
		panelCUSTOM.setBounds(204, 567, 565, 23);
		...
		panelIR = new JPanel();
		panelIR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelIR.setBackground(new Color(51, 51, 61));
		...
		btnPC.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		panelPC = new JPanel();
		panelPC.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelPC.setBackground(new Color(51, 51, 61));
		...
		btnIR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnMAR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnMBR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnX1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnX2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnX3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnR0.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnR1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnR2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnR3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnCUSTOM.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		btnCUSTOM.setBounds(10, 557, 188, 32);
		frmCsciSimulator.getContentPane().add(btnCUSTOM);

		btnCC = new JButton("CC");
		btnCC.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		btnMFR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		frmCsciSimulator.getContentPane().add(btnMFR);
				...
				panelCC = new JPanel();
				panelCC.addComponentListener(new ComponentAdapter() {
					@Override
					public void componentResized(ComponentEvent e) {
					}
				});
				panelCC.setBackground(new Color(51, 51, 61));
		...
		panelMFR = new JPanel();
		panelMFR.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		panelMFR.setBackground(new Color(51,51,61));
		...
		label_1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_2.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_3.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_4.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_5.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_6.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_7.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_8.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_9.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_11.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_12.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_13.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		label_14.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		monitor.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 14));
		scrollPane.setViewportView(monitor);
		monitor.setEditable(false);
		monitor.setLineWrap(true);

		btnIPL = new JButton("IPL");
		btnIPL.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		txtpnPleaseHitIpl.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		txtpnSetupEach.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		txtpnSetupEach.setForeground(Color.WHITE);
		...
		txtpnSetupEach.setBackground(new Color(51,51,61));
		...
		txtpnToRun.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		txtpnToRun.setForeground(Color.WHITE);
		...
		separator_16.setBounds(11, 551, 758, 3);
		...
		btn_SendProgram1.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		btn_SendProgram1.setBounds(1274, 254, 89, 23);
		frmCsciSimulator.getContentPane().add(btn_SendProgram1);

		JTextPane txtpnPleaseEnter = new JTextPane();
		txtpnPleaseEnter.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		txtpnPleaseEnter.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 12));
		txtpnPleaseEnter.setBackground(new Color(51,51,61));
		txtpnPleaseEnter.setForeground(Color.WHITE);
		...
		txtpnPleaseEnter.setBounds(1253, 40, 236, 250);
		frmCsciSimulator.getContentPane().add(txtpnPleaseEnter);

		separator_17 = new JSeparator();
		separator_17.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		...
		JTextPane txtpnProgramAplease = new JTextPane();
		txtpnProgramAplease.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		txtpnProgramAplease.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 12));
		txtpnProgramAplease.setBackground(new Color(51,51,61));
		txtpnProgramAplease.setForeground(SystemColor.text);
		txtpnProgramAplease.setText("\tPROGRAM 2\r\n\r\na.Please hit Start. The screen will display a paragraph of 6 senteces loaded from a file.\r\n\r\nb. You will be prompted to enter a word you would like to find on the paragraph.\r\n\r\nc. Hit FIND and we will find the word for you");
		txtpnProgramAplease.setEditable(false);
		txtpnProgramAplease.setBounds(1253, 300, 236, 207);
		frmCsciSimulator.getContentPane().add(txtpnProgramAplease);
		
		JLabel lblKeyboard = new JLabel("KEYBOARD", SwingConstants.CENTER);
		lblKeyboard.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(ComponentEvent e) {
			}
		});
		lblKeyboard.setForeground(Color.WHITE);
		lblKeyboard.setFont(new Font("Tahoma", Font.BOLD, 24));
	...
	public void addListeners() {
		...
		btnIPL.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				...
				register.setFR0("0000000000000000");
				register.setFR1("0000000000000000");
		...
		//when Start program 2 button is pressed
		btn_StartProgram2.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) 
			{
				
				program2 = new Program2();
				paragraph = program2.readFromFile();
				//Make a call to Program2 readFromFile() method
				//return a string read from program2Paragraph file
				//Display the paragraph onto screen
				printMessage(paragraph);
		...
		btn_FindProgram2.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) 
			{
				//ask for input word
				String wordToFind = textBox.getText();
				printMessage("\n You entered: " + wordToFind);
				//safe input word into memory starting location 12
				program2.storeWordToFind(wordToFind, memory);
				int count = UnitConverter.binaryStringToInteger(memory.getFromMemory(24));
				int i =1;
				int startAddress = UnitConverter.binaryStringToInteger(memory.getFromMemory(20));
				int endAddress = UnitConverter.binaryStringToInteger(memory.getFromMemory(21));
				register.setPC(UnitConverter.integerTo16BitBinary(startAddress));
				
				do{
					
					
					int a = UnitConverter.binaryStringToInteger(register.getPC());
					printMessage("Taking instruction at location: " + a);
					execute(memory.getFromMemory(UnitConverter.binaryStringToInteger(register.getPC())));
					if(UnitConverter.binaryStringToInteger(register.getPC()) == endAddress ) {
						a = UnitConverter.binaryStringToInteger(register.getPC());
						printMessage("Taking instruction at location: " + a);
						execute(memory.getFromMemory(UnitConverter.binaryStringToInteger(register.getPC())));
						register.setPC(UnitConverter.integerTo16BitBinary(startAddress));
					}
			...
			//	while (UnitConverter.binaryStringToInteger(memory.getFromMemory(18)) != 1);
				
				

				if(program2.paragraph.indexOf(program2.word) == -1) {
					printMessage("word Not Found");
				}
				else {
					int wordCount = 1;
					int sentenceCount = 1;
					int end = program2.paragraph.indexOf(program2.word);
					String sub = program2.paragraph.substring(0,end+1);
					...
					printMessage("word Found at sentence: " + sentenceCount + ", word number: " + wordCount);

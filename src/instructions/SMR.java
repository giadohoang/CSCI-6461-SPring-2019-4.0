	...
	public void execute(String instruction, Registers register, Memory memory) {
		...
		// TODO Auto-generated method stub
				...
				//Extract r,x,i, and effective address (EA)
					...
					register.setMBR(memory.getFromMemory(UnitConverter.binaryStringToInteger(effectiveAddress)));
					...
					int difference = Math.abs(UnitConverter.binaryStringToInteger(register.getGPRj(r)) - UnitConverter.binaryStringToInteger(register.getMBR()));
